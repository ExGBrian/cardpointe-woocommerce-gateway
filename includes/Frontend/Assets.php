...
final class Assets {
	...
	public static function i18n(): array {
		return array(
			'enterCard'        => __( 'Please enter your card details.', 'paradox-cardpointe-gateway' ),
			'enterBank'        => __( 'Please enter your bank routing and account numbers.', 'paradox-cardpointe-gateway' ),
			'invalidCard'      => __( 'The card details are not valid. Please check them and try again.', 'paradox-cardpointe-gateway' ),
			'invalidBank'      => __( 'Enter your routing number, a slash, then your account number (for example 123456789/000123456).', 'paradox-cardpointe-gateway' ),
			'cardNotAccepted'  => __( '%s cards are not accepted.', 'paradox-cardpointe-gateway' ),
			'chooseAccttype'   => __( 'Please choose your bank account type.', 'paradox-cardpointe-gateway' ),
			'consentRequired'  => __( 'Please authorize the bank account debit to continue.', 'paradox-cardpointe-gateway' ),
			'timeout'          => __( 'The secure payment form did not respond. Please re-enter your details.', 'paradox-cardpointe-gateway' ),
			'loading'          => __( 'Loading secure payment form…', 'paradox-cardpointe-gateway' ),
			'detected'         => __( 'Card type: %s', 'paradox-cardpointe-gateway' ),
			'brands'           => CardTypes::options(),
			'errorCodes'       => array(
				'1001' => __( 'Invalid account number.', 'paradox-cardpointe-gateway' ),
				'1002' => __( 'Invalid security code.', 'paradox-cardpointe-gateway' ),
				'1003' => __( 'Invalid expiration date.', 'paradox-cardpointe-gateway' ),
				'1004' => __( 'Card number is required.', 'paradox-cardpointe-gateway' ),
				'1005' => __( 'Security code is required.', 'paradox-cardpointe-gateway' ),
				'1006' => __( 'Expiration date is required.', 'paradox-cardpointe-gateway' ),
			),
		);
	}
		...
		if ( 'woocommerce_page_wc-settings' === $screen_id && Plugin::is_our_gateway( $section ) ) {
			...
			wp_localize_script(
				...
				array(
					...
					'i18n'      => array(
						'testing'   => __( 'Testing connection…', 'paradox-cardpointe-gateway' ),
						'success'   => __( 'Connected.', 'paradox-cardpointe-gateway' ),
						'failure'   => __( 'Connection failed.', 'paradox-cardpointe-gateway' ),
						'yes'       => __( 'Yes', 'paradox-cardpointe-gateway' ),
						'no'        => __( 'No', 'paradox-cardpointe-gateway' ),
						'labels'    => array(
							'host'        => __( 'Host', 'paradox-cardpointe-gateway' ),
							'site'        => __( 'Site', 'paradox-cardpointe-gateway' ),
							'enabled'     => __( 'Merchant enabled', 'paradox-cardpointe-gateway' ),
							'echeck'      => __( 'ACH / eCheck', 'paradox-cardpointe-gateway' ),
							'cvv'         => __( 'CVV verification', 'paradox-cardpointe-gateway' ),
							'avs'         => __( 'AVS verification', 'paradox-cardpointe-gateway' ),
							'acctupdater' => __( 'Account updater', 'paradox-cardpointe-gateway' ),
							'cardproc'    => __( 'Processor', 'paradox-cardpointe-gateway' ),
						),
					),
				)
			);
		...
		if ( $screen_id === Compatibility::order_screen_id() || 'shop_order' === $screen_id ) {
			...
			wp_localize_script(
				...
				array(
					...
					'i18n'    => array(
						'confirmVoid'    => __( 'Void this transaction? The customer will not be charged.', 'paradox-cardpointe-gateway' ),
						'confirmCapture' => __( 'Capture %s now?', 'paradox-cardpointe-gateway' ),
						'working'        => __( 'Working…', 'paradox-cardpointe-gateway' ),
						'error'          => __( 'The request failed. Please try again.', 'paradox-cardpointe-gateway' ),
					),
				)
			);
		}
